...
const PortfolioPage: React.FC = () => {
  ...
  const Section2 = ({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) => {
    ...
    return (
      <motion.div style={{ scale, rotate }} className="relative h-screen">
        <Image src="/2.jpeg" alt="Featured epoxy flooring project" fill style={{ objectFit: "cover" }} sizes="100vw" />
      </motion.div>
    );
  };
  ...
  const Section3 = ({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) => {
    ...
    return (
      <motion.div style={{ scale, rotate }} className="relative h-screen">
        <Image src="/4.jpeg" alt="Featured epoxy flooring project" fill style={{ objectFit: "cover" }} sizes="100vw" />
      </motion.div>
    );
  };
